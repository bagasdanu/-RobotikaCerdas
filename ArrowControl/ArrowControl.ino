...
void parseCommand(String input) {
  ...
  if (input == "TU") { doTilt(tiltStep + 2); return; }   // Tilt Up
  if (input == "TD") { doTilt(tiltStep - 2); return; }   // Tilt Down
  if (input == "PL") { setPan(panStep + 2);  Serial.print("[PAN] "); Serial.println(panPos); return; }  // Pan Left
  if (input == "PR") { setPan(panStep - 2);  Serial.print("[PAN] "); Serial.println(panPos); return; }  // Pan Right
